          ...
          <div className="col-12">
            <div className="mobile-header-elements">
              <div className="mobile-logo">
                <Link href="/">
                  <Image src="/assets/frontend/img/logo/header-logo1.png" alt="Mobile Logo" width={150} height={50} />
                </Link>
              </div>
      ...
      {isMobileSidebarOpen && (
        <div className="mobile-sidebar d-block d-lg-none">
          <div className="logo-m">
            <Link href="/">
              <Image src="/assets/frontend/img/logo/header3-logo.png" alt="Mobile Sidebar Logo" width={150} height={50} />
            </Link>
          </div>
