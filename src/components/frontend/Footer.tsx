          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="single-footer-items footer-logo-area">
              <div className="footer-logo">
                <Link href="#">
                  <Image src="/assets/frontend/img/logo/vortrex.png" alt="Footer Logo" width={150} height={40} />
                </Link>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-12">
            <div className="single-footer-items">
              ...
              <div className="contact-box">
                <div className="icon">
                  <Image src="/assets/frontend/img/icons/footer1-icon1.png" alt="Phone" width={30} height={30} />
                </div>
                <div className="pera">
              ...
              <div className="contact-box">
                <div className="icon">
                  <Image src="/assets/frontend/img/icons/footer1-icon2.png" alt="Phone" width={30} height={30} />
                </div>
                <div className="pera">
              ...
              <div className="contact-box">
                <div className="icon">
                  <Image src="/assets/frontend/img/icons/footer1-icon3.png" alt="Email" width={30} height={30} />
                </div>
                <div className="pera">
              ...
              <div className="contact-box">
                <div className="icon">
                  <Image src="/assets/frontend/img/icons/footer1-icon4.png" alt="Website" width={30} height={30} />
                </div>
                <div className="pera">
