              ...
              <div className="col-12">
                <div className="d-flex justify-content-between align-items-center header-elements">
                  <div className="site-logo">
                    <Link href="/">
                      <img src="/assets/frontend/img/logo/vortrex.png" alt="Logo" />
                    </Link>
                  </div>
          ...
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center mobile-header-elements">
              <div className="mobile-logo">
                <Link href="/">
                  <img src="/assets/frontend/img/logo/vortrex.png" alt="Mobile Logo" />
                </Link>
              </div>
        ...
        <div className="mobile-nav">
          ...
          <div className="single-footer-items mt-4">
            ...
            <div className="contact-box d-flex align-items-center gap-2 my-2">
              <div className="icon">
                <img src="/assets/frontend/img/icons/footer1-icon1.png" alt="" />
              </div>
              <div className="pera">
            ...
            <div className="contact-box d-flex align-items-center gap-2 my-2">
              <div className="icon">
                <img src="/assets/frontend/img/icons/footer1-icon2.png" alt="" />
              </div>
              <div className="pera">
            ...
            <div className="contact-box d-flex align-items-center gap-2 my-2">
              <div className="icon">
                <img src="/assets/frontend/img/icons/footer1-icon3.png" alt="" />
              </div>
              <div className="pera">
            ...
            <div className="contact-box d-flex align-items-center gap-2 my-2">
              <div className="icon">
                <img src="/assets/frontend/img/icons/footer1-icon4.png" alt="" />
              </div>
              <div className="pera">
