        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="heading2">
                <span className="span">
                  <img src="assets/frontend/img/icons/span2.png" alt="" /> Our Mission
                </span>
            ...
            <div className="col-lg-6">
              <div className="solution-images">
                <div className="image1">
                  <img src="assets/frontend/img/others/solution-img1.png" alt="" />
                </div>
                <div className="image2">
                  <img src="assets/frontend/img/others/solution-img2.png" alt="" />
                </div>
                <div className="image3">
                  <img src="assets/frontend/img/others/solution-img3.png" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center">
              ...
              <div className="images">
                <div className="row">
                  <div className="col-lg-12">
                    <div className="image">
                      <img src="assets/frontend/img/about/visiton-img1.png" alt="" />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="space30"></div>
                    <div className="image">
                      <img src="assets/frontend/img/about/visiton-img2.png" alt="" />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="space30"></div>
                    <div className="image">
                      <img src="assets/frontend/img/about/visiton-img3.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="heading2">
                <span className="span">
                  <img src="assets/frontend/img/icons/span2.png" alt="" /> Our Vision
                </span>
                ...
                <div className="item-box">
                  <div className="icon">
                    <div className="">
                      <img src="assets/frontend/img/icons/solution-iocn1.png" alt="" />
                    </div>
                  </div>
                  <div className="">
                    <h3>
                ...
                <div className="item-box">
                  <div className="icon">
                    <div className="">
                      <img src="assets/frontend/img/icons/solution-iocn2.png" alt="" />
                    </div>
                  </div>
                  <div className="">
                    <h3>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 m-auto text-center">
              <div className="heading2">
                <span className="span">
                  <img src="assets/frontend/img/icons/span2.png" alt="" /> Our Team
                </span>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="team-box">
                <div className="image-area">
                  <div className="image">
                    <img src="assets/frontend/img/team/team2-img1.png" alt="" />
                  </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="team-box">
                <div className="image-area">
                  <div className="image">
                    <img src="assets/frontend/img/team/team2-img2.png" alt="" />
                  </div>
                  <div className="icon-area">
                    <ul>
                      <li>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="team-box">
                <div className="image-area">
                  <div className="image">
                    <img src="assets/frontend/img/team/team2-img3.png" alt="" />
                  </div>
                  <div className="icon-area">
                    <ul>
                      <li>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="team-box">
                <div className="image-area">
                  <div className="image">
                    <img src="assets/frontend/img/team/team2-img4.png" alt="" />
                  </div>
                  <div className="icon-area">
                    <ul>
                      <li>
