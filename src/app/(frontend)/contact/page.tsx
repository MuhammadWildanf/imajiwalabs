              ...
              <div className="contact-boxs">
                ...
                <div className="contact-box d-flex">
                  <div className="icon me-3">
                    <Image src="/assets/frontend/img/icons/contact-page-icon1.png" alt="Phone Icon" width={40} height={40} />
                  </div>
                ...
                <div className="contact-box d-flex">
                  <div className="icon me-3">
                    <Image src="/assets/frontend/img/icons/contact-page-icon2.png" alt="Email Icon" width={40} height={40} />
                  </div>
                  <div className="heading">
                ...
                <div className="contact-box d-flex">
                  <div className="icon me-3">
                    <Image src="/assets/frontend/img/icons/contact-page-icon3.png" alt="Location Icon" width={40} height={40} />
                  </div>
                  <div className="heading">
